...
let expName = 'sancho';  // from the Builder filename that created this script
let expInfo = {
    'participant': '',
    'group': '',
    'session': '01',
...
function key_commandsLoopBegin(key_commandsLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisKey_command of key_commands) {
...
function task_orderLoopBegin(task_orderLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTask_order of task_order) {
...
function task_blockLoopBegin(task_blockLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisTask_block of task_block) {
...
function practice_trialLoopBegin(practice_trialLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisPractice_trial of practice_trial) {
...
function practice_fixationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practice_fixationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practice_ITIRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practice_ITIComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trial_fixationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trial_fixationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trial_targetRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trial_targetComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trial_ITIRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trial_ITIComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trial_breakRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trial_breakComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trials_endRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trials_endComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
